    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(SelectSurveyActivity.this, "두피케어 제품 찾기 버튼을 클릭하셨습니다.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_survey.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SelectSurveyActivity.this, SurveyActivity.class);
...
//                finish();
        ...
        btn_ingredients.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(SelectSurveyActivity.this, "화장품 성분 분석하기 버튼을 클릭하셨습니다.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}